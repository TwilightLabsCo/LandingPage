          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16">
            ...
            <div>
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center gap-3 text-sm text-foreground">
                  <svg className="w-5 h-5 text-primary flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" /></svg>
