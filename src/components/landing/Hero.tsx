      ...
      <div className="container mx-auto px-4 sm:px-6 py-16 md:py-20 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="animate-fade-up-delay-3 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-muted-foreground text-xs sm:text-sm">
            ...
            <span className="flex items-center gap-1.5">
              <svg className="w-4 h-4 text-primary" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" /></svg>
              NDA Protected
            </span>
          </div>
        </div>
